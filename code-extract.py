...
def main():
  ...
  parser.add_argument('transcripts', metavar='transcripts', help='one or more transcript CSV files', nargs='+')
...
# Check outputdir
  ...
  with open(args['codebook'], 'r') as codeFile: 
    ...
    if( args['update'] ):
      ...
      interviews,codeCountsPerSpeaker = readOriginalCSVs( args['transcripts'], codes, outputdir, codeCountsPerSpeaker )
